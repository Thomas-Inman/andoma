...
if __name__ == "__main__":
    ...
    if os.name == 'nt':
        ...
        modelName, targetModelName = "/checkpoints/3_model200.h5", "/checkpoints/3_targetModel200.h5"
    # init dqn
    dql = DeepQLearning(env, (12, 8, 8), 500, 64, 0.7, 0.9, 0.1, 0.95, False, True)
    if os.name == 'nt':
        dql.load(modelName, targetModelName)
        ...
        dql.load(PATH + modelName, PATH + targetModelName)
        try:
            f = open(PATH + f"/results/3_200_res.csv", 'a')
        except FileNotFoundError:
            f = open(PATH + f"/results/3_200_res.csv", 'w')
    for i in range(20):
        board.reset()
    ...
    if os.name == 'nt':
        ...
        modelName, targetModelName = "/checkpoints/3_model100.h5", "/checkpoints/3_targetModel100.h5"
    # init dqn
    ...
    if os.name == 'nt':
        ...
        dql.load(PATH + modelName, PATH + targetModelName)
        try:
            f = open(PATH + f"/results/3_100_res.csv", 'a')
        except FileNotFoundError:
            f = open(PATH + f"/results/3_100_res.csv", 'w')
    for i in range(20):
        board.reset()
