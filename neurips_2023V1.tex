...
\author{
  Thomas Inman \\
  260947857 \\
  \texttt{thomas.inman@mail.mcgill.ca} \\
...
Do {\bf not} include this section in the anonymity submission, only in the final paper. You can use the \texttt{ack} environment provided in the style file to automatically hide this section in the anonymized submission.
\end{ack}
